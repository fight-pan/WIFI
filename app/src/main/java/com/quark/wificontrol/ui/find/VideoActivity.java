...
//    private static final String VIDEO_URL = "http://b.icloud-u.com/Uploads/Video/2016-08-11/57ac2812b5275.mp4";
...
//    TextView mStart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.textvedio);
        VIDEO_URL = (String) getValue4Intent("url");

        VIDEO_URL = ApiHttpClient.loadVideo  +VIDEO_URL;

        TLog.error("视频地址："+VIDEO_URL);

        mVideoLayout = findViewById(R.id.video_layout);
//        mBottomLayout = findViewById(R.id.bottom_layout);
//        head = (RelativeLayout)findViewById(R.id.head);//
//        head.setBackground(ContextCompat.getDrawable(this,R.drawable.black_bg));
