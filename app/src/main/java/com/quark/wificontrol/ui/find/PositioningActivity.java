...
import com.quark.api.auto.bean.City;
import com.quark.wificontrol.AppParam;
import com.quark.wificontrol.R;
import com.quark.wificontrol.base.BaseActivity;
import com.quark.wificontrol.ui.widget.DBHelper;
import com.quark.wificontrol.ui.widget.DatabaseHelper;
import com.quark.wificontrol.ui.widget.MyLetterListView;
import com.quark.wificontrol.util.PingYinUtil;
...
/**
 * Created by pan on 2016/9/27 0027.
 * >#
 * >#城市定位
 */
public class PositioningActivity extends BaseActivity implements AbsListView.OnScrollListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 4) {
                    ...
                    Toast.makeText(getApplicationContext(), "城市搜索当前页面下的城市，这里跳转", Toast.LENGTH_SHORT).show();
        ...
        resultList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                Toast.makeText(getApplicationContext(), "这里是搜素之后的城市", Toast.LENGTH_SHORT).show();
            }
        });
        initOverlay();
        cityInit();
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (viewType == 0) { // 定位
                ...
                city.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (locateProcess == 2) {
                            ...
                            Toast.makeText(getApplicationContext(), "这里是当前定位城市", Toast.LENGTH_SHORT).show();
                ...
                if (locateProcess == 1) { // 正在定位
                    ...
                    //保存当前定位城市
                    new AppParam().setSharedPreferencesy(PositioningActivity.this, "city", currentCity);
                } else if (locateProcess == 3) {
                ...
                rencentCity.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        Toast.makeText(getApplicationContext(), "这里是最近访问城市", Toast.LENGTH_SHORT).show();
                ...
                hotCity.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        //city_hot.get(position).getName()  城市
