 ...
 * >#同城信息分类列表
 */
public class CityTypeClassAdapter extends BaseAdapter {


    private Context context;
    private ArrayList<CityClassify02s> list;

    public CityTypeClassAdapter(Context context, ArrayList<CityClassify02s> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (list != null && list.size() >= 0){
            typeName.setText(list.get(position).getCity_classify_02_name());
        }
