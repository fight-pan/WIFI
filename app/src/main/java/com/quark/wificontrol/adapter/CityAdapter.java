...
public class CityAdapter extends RecyclerView.Adapter<CityAdapter.ViewHolder> {
    ...
    public CityAdapter(Context context, ArrayList<ListCityInformation> list, Handler handler) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.removeTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                msg.what = 301;
                msg.arg1 = list.get(position).getCity_information_id();
...
//        TextView distanTv = (TextView) convertView.findViewById(R.id.distance_tv);
...
//        ApiHttpClient.loadImage(list.get(position).getImages_01(), videoIv, R.drawable.nearby);
//        timeTv.setText(list.get(position).getPost_date());
//        distanTv.setText(list.get(position).getDistance());
//        return convertView;
//    }
}
