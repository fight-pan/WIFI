...
public class ShopFragment extends BaseFragment implements XListView.IXListViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        oneViewt = inflater.inflate(R.layout.fragment_shop, container, false);
            ...
            if (kd != null) {
                ...
                if (info.getStatus() == 1) {
                    ...
                    if (tin.size() > 0 && tin != null) {
                        ...
                        adapter = new MyTeachAdapter(getActivity(), datas, handler);
                        xlstv.setAdapter(adapter);
//                        adapter.setOnItemClickListener(new MyTeachAdapter.OnItemClickListener() {
//                            @Override
//                            public void OnItemClick(View view, int positon) {
//                                Intent intent = new Intent(getActivity(), PeopelDetailsActivity.class);
//                                intent.putExtra("people_services_id", datas.get(positon).getPeople_services_id() + "");
//                                startActivity(intent);
//                            }
//
//                            @Override
//                            public void OnLongItemClick(View view, int positon) {
//
//                            }
//                        });
